✔ This directory contains the deployable code which predicts the gesture signed by the user, and the classification time taken for each gesture on a RaspberryPi-Zero.
